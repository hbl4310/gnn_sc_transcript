...
# TODO remove dependency on device in init
# this seems like a wrapper class around HetAgg; dismantle this to make functional 
class HetGNN(object):
    def __init__(self, args, device='cpu'):
        ...
        self.model = HetAgg(args, feature_list, a_neigh_list_train, p_neigh_list_train, v_neigh_list_train,\
         a_train_id_list, p_train_id_list, v_train_id_list)
